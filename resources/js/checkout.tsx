...
} from "./components/StripeSaveCard";
...
function parseJson<T>(
  ...
  try {
    ...
    console.error(
      "No se pudo interpretar JSON desde data-*:",
      error,
    );
    ...
    createRoot(element).render(
      <MercadoPagoCardCheckout
        ...
        description={
          element.dataset
            .description ??
          "Pago desde Mercado Pago Card Brick"
        }
      />,
    );
  });
...
document
  .querySelectorAll<HTMLElement>(
    "[data-stag-herd-checkout='stripe-save-card']",
  )
  .forEach((element) => {
    createRoot(element).render(
      <StripeSaveCard
        ...
        onStatusChange={(
          ...
          dispatchCheckoutEvent(
            element,
            "stag-herd:stripe-save-card-status",
            {
              status,
              message,
            },
        ...
        onError={(error) => {
          dispatchCheckoutEvent(
            element,
            "stag-herd:stripe-save-card-error",
            {
              error,
            },
          );
    ...
    createRoot(element).render(
      <StripeSavedCardsCheckout
        ...
        onStatusChange={(
          ...
          dispatchCheckoutEvent(
            element,
            "stag-herd:stripe-checkout-status",
            {
              status,
              message,
            },
        ...
        onSuccess={(
          ...
          dispatchCheckoutEvent(
            element,
            "stag-herd:stripe-checkout-success",
            {
              response,
              context,
            },
        ...
        onError={(error) => {
          dispatchCheckoutEvent(
            element,
            "stag-herd:stripe-checkout-error",
            {
              error,
            },
          );
