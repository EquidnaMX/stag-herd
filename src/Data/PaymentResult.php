...
class PaymentResult
{
    ...
    /**
     * Creates a refunded payment result.
     *
     * @param string $reason Reason for refund.
     *
     * @return self New refunded result instance.
     */
    public static function refunded(string $reason = 'Refunded'): self
    {
        return new self(
            error: false,
            result: 'REFUNDED',
    ...
    /**
     * Creates a chargeback payment result.
     *
     * @param string $reason Reason for chargeback.
     *
     * @return self New chargeback result instance.
     */
    public static function chargeback(string $reason = 'Chargeback'): self
    {
        return new self(
            error: true,
            result: 'CHARGEBACK',
